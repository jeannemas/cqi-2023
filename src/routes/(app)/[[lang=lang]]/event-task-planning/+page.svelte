...
>
  ...
  <input
    type="date"
    id="eventTaskStartDate"
    bind:value="{eventTaskStartDate}"
    required
  />
  ...
  <input
    type="date"
    id="eventTaskEndDate"
    on:change="{manageEndDate}"
    bind:value="{eventTaskEndDate}"
    required
  />
  ...
  <input
    type="time"
    id="eventTaskEndTime"
    on:change="{manageEndTime}"
    bind:value="{eventTaskEndTime}"
    required
  />
